...
const locationInfo = (req, res) => {
  res.render('location-info', {
    ...
    sidebar: {
      context:
        'is on Loc8r because it has accessible wifi and space to\
         sitdown with your laptop and get some work done.',
      callToAction:
      ...
      reviews: [
        {
          ...
          reviewText:
            "What a great place. I can't say enough good things\
            \n about it.",
        },
        {
          ...
          reviewText:
            "It was okay. Coffee wasn't great, but the wifi\
            \n was fast.",
        },
      ],
    },
